...
console.log(`- Losango de diagonal maior 32cm, diagonal menor 18cm: ${Ex.getDiamondArea(200, 50)}cm`);
console.log(`- Losango de diagonal maior 32cm, diagonal menor 18cm: ${Ex.getDiamondArea(75, 25)}cm`);
// Exercício 02
...
console.log(`- Trapézio de base maior 100cm, base menor 70cm e altura 50cm: ${Ex.getTrapezeArea(75, 50, 35)}cm`);
console.log(`- Trapézio de base maior 100cm, base menor 70cm e altura 50cm: ${Ex.getTrapezeArea(150, 120, 80)}cm`);
// Exercício 03
