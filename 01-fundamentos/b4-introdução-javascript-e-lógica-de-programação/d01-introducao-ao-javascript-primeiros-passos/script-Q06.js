...
let peca = pecasXadrez.toLocaleLowerCase();

if (peca === "rei") {
    console.log("Move-se em qualquer direção, porém apenas uma casa por vez.");
} else if (peca === "dama") {
    console.log("Move-se em qualquer direção (vertical, horizontal e diagonal), quantas casas quiser.");
} else if (peca === "bispo") {
    ...
    console.log("Peça inválida, não existente no tabuleiro.")
}